...
From the ANOVA, the F-value for `recent_development.x` is $32.734$, with an associated p-value of $1.55e-12$. From the ANOVA by itself, we cannot determine which pairs have significantly different means. So we conducted Fisher's LSD to determine which pairs are significantly different. The p-value between developed and developing countries was $9.2e-13$. Similarly, the p-value between developed and recently developed countries was $0.01$. Finally, the p-value between developing and recently developed countries was $0.61$.
...
From the Kruskal Wallis test alone, we cannot determine which pairs have significantly different medians. Thus, we then conducted individual Kruskal Wallis Rank Sum tests and the Dunn test to determine which pairs are significantly different. For developed and developing countries the p-value was $3.5e-12$ and approximately $0$, respectively. For developed and recently developed countries, the p-value was $0.0091$ and $0.0029$. Finally, for developinga and recently developed countries, the associated p-value was $0.76$ and $0.41$.
