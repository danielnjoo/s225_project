...
Our final, combined dataset, includes 33,559 flights with the following variables of interest:

- **Destination Airport** - listed as an IATA code.
...
- **Stops** - Whether or not the flight was direct or indirect.
- **Source Airport** - also listed as an IATA code.
...
- **Year.X** - Per Capita GDP of the source country each year from 2010 to 2016 measured in USD.
- **Year.Y** - Per Capita GDP of the destination country each year from 2010 to 2016 measured in USD.
- **GrowthYear_NextYear.X** - Per Capita GDP growth of source country between two years measured in USD.
- **GrowthYear_NextYear.Y** - Per Capita GDP growth of destination country between two years measured in USD.
...
> Below should be in the analysis section
...
\end{tabular}
\end{table}
> Above should be in Analysis section
