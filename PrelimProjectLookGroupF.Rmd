...
The Non-parametric Kruskal Wallis test provides an alternative to the one-way Parametric ANOVA. Similar to the ANOVA, it tests for differences in center. 
