...
> I'm getting missing ros here. Only two of the 5 plot on the map.
...
If we include travel within one's own country (`source.country` can equal `destination.country`), the results are exactly the same:
...
but differ slightly for the developing ones:
