...
Having compared via visualization, we know move onto comparison by proportion tests, where we'll compare the proportions of flights to  the top5 developed nation destinations to total nation status flight counts, between developing  and developed nations.
