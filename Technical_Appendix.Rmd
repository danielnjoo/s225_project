...
ggplot(developed_dests_n_ext,aes(factor(Country.Code.y),n_count,col=factor(top5))) + 
  ...
  labs(y="Log Normalized Count", x="Destination", fill="Top5", title="Top 5 Destinations of Developed Country Travel")
```
...
data.frame(Countries=c("GBR","DEU","ESP","ITA","FRA"), Developed=developedcounts, Developing=developingcounts) %>% 
  melt() %>% 
